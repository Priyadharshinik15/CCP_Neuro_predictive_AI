...
export const NAV_ITEMS = [
  ...
  NavigationTab.AIWorkbench,
  NavigationTab.Generator,
  NavigationTab.Scanner,
  NavigationTab.Map,
  NavigationTab.UserGuide,
  NavigationTab.Profile,
];

export const ICONS: { [key in NavigationTab]: JSX.Element } = {
  [NavigationTab.Dashboard]: <LayoutDashboardIcon />,
  [NavigationTab.AIWorkbench]: <FlaskConicalIcon />,
  [NavigationTab.Generator]: <FilePlus2Icon />,
  [NavigationTab.Scanner]: <CameraIcon />,
  [NavigationTab.Map]: <GlobeIcon />,
  [NavigationTab.UserGuide]: <BookOpenIcon />,
  [NavigationTab.Profile]: <UserIcon />,
};
...
function FlaskConicalIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2v7.31" /><path d="M14 9.31V2" /><path d="M3.5 9.31 9 20a1 1 0 0 0 1.664.04l5-10.69A.5.5 0 0 1 16 9h-2a.5.5 0 0 0-.336.14L9.5 13.56" /><path d="M8.5 9.31 15 20a1 1 0 0 1-1.664.04l-5-10.69A.5.5 0 0 0 8 9h2a.5.5 0 0 1 .336.14L14.5 13.56" /><path d="M7 16.69 17 3.31" /></svg>
  );
}

function FilePlus2Icon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 22h14a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v4" /><path d="M14 2v4a2 2 0 0 0 2 2h4" /><path d="M3 15h6" /><path d="M6 12v6" /></svg>
  );
}
